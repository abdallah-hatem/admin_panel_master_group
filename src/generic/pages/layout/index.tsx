import type { MenuChild, MenuList } from '@/generic/interface/layout/menu.interface';
...
import { getMenuList } from '@/generic/api/layout.api';
import { setUserItem } from '@/generic/stores/user.store';
import { getFirstPathCode } from '@/generic/utils/getFirstPathCode';
