...
import NoticeSvg from '@/assets/header/noticeSvg';
import { getNoticeList } from '@/generic/api/layout.api';
import { EventStatus } from '@/generic/interface/layout/notice.interface';
